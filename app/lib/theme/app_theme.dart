    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        displayLarge: const TextStyle(
          fontFamily: 'Georgia', fontSize: 57, fontWeight: FontWeight.w400,
          letterSpacing: -0.25, color: charcoal,
        ),
        displayMedium: const TextStyle(
          fontFamily: 'Georgia', fontSize: 45, fontWeight: FontWeight.w400,
          color: charcoal,
        ),
        // Headline
        headlineLarge: const TextStyle(
          fontFamily: 'Georgia', fontSize: 32, fontWeight: FontWeight.w700,
          letterSpacing: -0.5, color: charcoal,
        ),
        headlineMedium: const TextStyle(
          fontFamily: 'Georgia', fontSize: 28, fontWeight: FontWeight.w700,
          letterSpacing: -0.3, color: charcoal,
        ),
        ...
        titleLarge: TextStyle(
          ...
          letterSpacing: -0.2, color: charcoal,
        ),
        titleMedium: TextStyle(
          fontSize: 16, fontWeight: FontWeight.w700,
          letterSpacing: -0.1, color: charcoal,
        ),
        ...
        // Body
        bodyLarge: TextStyle(
          fontSize: 16, height: 1.55, color: charcoal.withValues(alpha: 0.85),
        ),
        bodyMedium: TextStyle(
          fontSize: 14, height: 1.55, color: charcoal.withValues(alpha: 0.80),
        ),
        bodySmall: TextStyle(
          fontSize: 12, height: 1.5, color: charcoal.withValues(alpha: 0.65),
        ),
        // Label
        labelLarge:  const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, letterSpacing: 0.1),
        labelMedium: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, letterSpacing: 0.3),
        labelSmall:  const TextStyle(fontSize: 11, fontWeight: FontWeight.w600, letterSpacing: 0.5),
      ),
      ...
      dividerTheme: const DividerThemeData(
        color: Color(0xFFE4EAE7), space: 1, thickness: 1,
      ),
